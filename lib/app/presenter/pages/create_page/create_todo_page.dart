...
class _CreateTodoPageState extends BaseStateTaski<CreateTodoPage> {
  ...
  late CreateTaskiController _controller;

  @override
  onReady() {
    _controller = context.read<CreateTaskiController>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocListener<CreateTaskiController, TasksState>(
              ...
              case TaskStatus.loaded:
                {
                  ...
                  hideLoader();
                  context.read<PageStateController>().next(0);
                        ...
                        children: [
                          Checkbox(
                              ...
                              shape: ContinuousRectangleBorder(
                                side: BorderSide(
                                    color:
                                        const Color.fromARGB(255, 96, 98, 102)),
