...
class CreateTodoPage extends StatefulWidget {
  ...
  const CreateTodoPage({super.key, required TaskController controller})
...
class _CreateTodoPageState extends BaseStateTaski<CreateTodoPage> {
  ...
  Widget build(BuildContext context) {
    final pageController = context.read<PageStateController>();
    return Scaffold(
            ...
            case TaskStatus.erro:
              {
                ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text(state.erro ?? "Erro desconhecido")));
                return;
              }
            case _:
              hideLoader();
                ...
                children: [
                    ...
                    children: [
                      Checkbox(
                          ...
                          shape: ContinuousRectangleBorder(
                            side: BorderSide(
                                color: const Color.fromARGB(255, 96, 98, 102)),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      validator: Validatorless.multiple([
                        Validatorless.min(
                            5, "O campo precisar ter no mínimo 5 caracteres"),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      validator: Validatorless.multiple([
                        Validatorless.min(
                            10, "O campo precisar ter no mínimo 10 caractres"),
                        Validatorless.required("Campo requerido")
                      ]),
                      decoration: InputDecoration(
                          icon: Icon(
                    ...
                    child: TextButton(
                      onPressed: () {
                        ...
                        if (isValid) {
                          ...
                          clearTextFields();
                          widget._controller.createTask(task);
                        }
                      },
                      child: Text(
                        'Create',
